...
export default function ConsultaCertificadosPersonas() {
    ...
    <div>
      <section className="bg-primary text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mt-2 safety-stripe">Certificados de Personas</h1>
          <p className="text-gray-200 max-w-2xl mt-6 leading-relaxed">
            Consulte certificados de personas digitando su número de identificación y código de carné.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        ...
        >
          {error ? (
            ...
            <iframe
              key={retry}
              src="https://intranet.ricertificacion.com/_Modulos/ConsultaCarne"
              title="Certificados de Personas"
